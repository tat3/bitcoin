...
sendBitcoin = withBitcoinConnection $ \(sock, version) -> do
  let -- TxInの作成
    outTxId  = toChars . BS.reverse $ readHex "eda202b686b868741c927afe7fc9526070f50221f7923cda95541fed897a432b"
  ...
  let -- 署名の作成
    subscript    = VarStr.fromByteString $ readHex "76a91459e0df616594d7a91ad3fea88b3fa366030e664888ac"
